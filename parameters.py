...
ray_quad = "quadrature_gaussian_16x4.dat" # file where the angular quadrature is read from
...
especial = True              # Use different JKQ for each component in the He 1083 multiplet (red-blue)
