...
class conditions:
    ...
    def __init__(self, parameters):
        ...
        self.separate_components = parameters.separate_components
        ...
        atom = ESE(0.,0.,np.zeros((3)),0.,self.JS, separate_components=self.separate_components)
        atom = atom.atom
...
class state:
    ...
    def __init__(self, cdts):
        ...
        self.atomic = [ESE(cdts.v_dop, cdts.a_voigt, vec, cdts.temp,\
                           cdts.JS, cdts.equi, iz, cdts.separate_components)
