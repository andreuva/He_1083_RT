...
class line_class():
    ...
    def __init__(self, multiterm, data, JS):
        ...
        if self.multiterm:
            ...
            # separate_components treatment
            self.separate_components = False
    ...
    def initialize_profiles_first(self, nus_N):
        """ Initialize to zero the line profiles the first time
            ...
            Internal: Makes self.prof equal to zero (or the components
                      of the dictionary is self.separate_components)
        """
    ...
    def add_contribution_profiles(self, contr, nu0=None):
        """ Add Contritubion to the line profile
            Input:
              ...
              nu0: If self.separate_components, the contribution is added to the
    ...
    def fill_Jqq(self):
        """ Get the q q' components of Jqq' that have not been computed yet
            ...
            Note: This routine manages the call of the actual routine
                  ...
                  for the self.separate_components case
        """
...
class HeI_1083():
    ...
    """
    def __init__(self,JS,B=0.0,separate_components=False):
...
#                                                    55, 35, 15., 2.5], JS))
        ...
        # If separate_components Helium case
        if separate_components:

            # Flag the line as separate_components
            self.lines[0].separate_components = True
...
class ESE:
    ...
    def __init__(self, v_dop, a_voigt, B, T, jsim, equilibrium=False, iz=0, separate_components=True):
        ...
        # Initialize atom
        self.atom = HeI_1083(jsim, B=self.B, separate_components=separate_components)
...
################################################################################
    ...
    def solveESE_MT(self, rad, cdt):
        ...
        for line in self.atom.lines:
            ...
            # If line is not separate_components, we can get the Jqq already
            if not line.separate_components:
                Jqq = line.get_Jqq()
                        ...
                        for indexk in terml.index:
                            ...
                            if (ik == il and ik1 == il) or \
                               (ik == il1 and ik1 == il1):
                                ...
                                # Get Jqq if separate_components
                                if line.separate_components:
